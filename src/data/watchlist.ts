...
export const commandAlias = 'pulse'
...
export const reportChecklist = [
  ...
  'For each watched item include the important finding or findings, with headline, version, exact date, why it matters, and official source links.',
  'Store findings under the correct watched item as a running Findings log instead of mixing different libraries together.',
...
export const masterPrompt = [
  ...
  '- Keep instructions separate from findings. Do not append research results into the master prompt.',
